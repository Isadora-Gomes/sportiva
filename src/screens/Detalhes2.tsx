...
export default function Detalhes() {
    ...
    const images = [
        require('../../assets/img/produto3.png'),
        require('../../assets/img/mochila2.png'),
        require('../../assets/img/mochila3.png'),
    ];
    ...
    return (
        <SafeAreaView style={[styles.container, { paddingTop: insets.top }]}> 
            <ScrollView contentContainerStyle={styles.content}>
                ...
                <Text style={styles.title}>MOCHILA POP</Text>
                <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                    <Text style={styles.price}>R$ 399,90</Text>
                ...
                <Text style={styles.description}> Praticidade e atitude: amplo espaço interno, compartimentos organizados
            e materiais duráveis — ótima para estudos, trabalho e passeios.</Text>
